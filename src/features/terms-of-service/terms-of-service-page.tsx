  ...
  return (
    <>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <Card className="text-center border-0 shadow-none bg-background">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">These terms form a binding legal agreement</p>
                </CardContent>
              </Card>
              <Card className="text-center border-0 shadow-none bg-background">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">Understand what you can and cannot do</p>
                </CardContent>
              </Card>
              <Card className="text-center border-0 shadow-none bg-background">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">Know your obligations when using our services</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 2xl:px-28 max-w-[1600px]">
          <div className="max-w-3xl mx-auto">
            <SectionHeader
              ...
              description="Find answers to frequently asked questions about our terms and conditions."
            />
      ...
      <CTASection
        ...
        description="Our legal team is available to help with any questions about our terms of service."
        primaryCTA={{
          label: "Contact Legal Team",
          href: "mailto:legal@brokle.ai",
        }}
        secondaryCTA={{
